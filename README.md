...
* Note on v5.0: A lot has happened since the initial version of the editor. ownNotes / nextNotes project for NextCloud seems to have died and there is no need anymore to try to mimic their behavior and notes / groups handling. Therefore, its time for some re-design :-)
